...
export default function ProfileModal() {
  ...
  const [formData, setFormData] = useState({
    firstName: actionData?.field?.firstName || user?.profile?.firstName,
    lastName: actionData?.field?.lastName || user?.profile?.lastName,
    department:
      actionData?.field?.department || user?.profile?.department || 'MARKETING',
